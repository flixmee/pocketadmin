...
func TestCollectionDBExport(t *testing.T) {
	...
	for i, s := range scenarios {
		t.Run(fmt.Sprintf("%d_%s", i, s.typ), func(t *testing.T) {
			...
			c.Rearrange = types.JSONMap[any]{"layout": []any{"f1", "f2"}}
