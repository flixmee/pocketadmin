import { getMediaSelectionLabel, isMediaFileURL, normalizeMediaFileURL } from "@/media/utils";
...
export function input(props) {
    ...
    function updateRecordValue(paths = []) {
        ...
        props.record[props.field.name] = props.field.maxSelect > 1 ? normalized : normalized?.[0] || "";
        triggerChangeEvent();
    }
