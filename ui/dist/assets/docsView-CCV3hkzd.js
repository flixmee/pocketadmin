import{t as e}from"./expandInfo-C6Q5uc4S.js";import{t as n}from"./fieldsInfo-B3znipu9.js";function r(r){let i=app.utils.getApiExampleURL(),a=r.viewRule===null,o={collectionId:r.id,collectionName:r.name},s=[{title:200,value:JSON.stringify(Object.assign(o,app.utils.getDummyFieldsData(r)),null,2)}];return a&&s.push({title:403,value:`
                {
                  "status": 403,
